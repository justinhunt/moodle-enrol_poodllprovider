...
/**
 * Tests for the enrol_poodllprovider_plugin class.
 *
 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class enrol_poodllprovider_testcase extends advanced_testcase {
    ...
    /**
     * Test for enrol_poodllprovider_plugin::delete_instance().
     */
    ...
    public function test_get_user_enrolment_actions() {
        ...
        $pluginname = 'poodllprovider';

        // Only enable the poodllprovider enrol plugin.
        ...
        // Teachers don't have enrol/poodllprovider:unenrol capability by default. Login as admin for simplicity.
        $this->setAdminUser();
        ...
        // poodllprovider enrolment has 1 enrol actions for active users -- unenrol.
