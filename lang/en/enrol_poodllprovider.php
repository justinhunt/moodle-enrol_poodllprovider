...
$string['privacy:metadata:enrol_poodllprovider_users'] = 'The list of users enrolled via an poodllprovider provider';
$string['privacy:metadata:enrol_poodllprovider_users:userid'] = 'The ID of the user';
$string['privacy:metadata:enrol_poodllprovider_users:lastgrade'] = 'The last grade the user was recorded of having';
$string['privacy:metadata:enrol_poodllprovider_users:lastaccess'] = 'The time when the user last accessed the course';
$string['privacy:metadata:enrol_poodllprovider_users:timecreated'] = 'The time when the user was enrolled';
