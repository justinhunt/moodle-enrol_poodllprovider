...
use enrol_poodllprovider\task\sync_members;
...
class sync_members_testcase extends advanced_testcase {
    ...
    /**
     * Test for sync_members::execute() when enrol_poodllprovider is disabled.
     */
    public function test_execute_enroldisabled() {
        ...
        $this->task->execute();
        $output = ob_get_clean();
        $message = 'Skipping task - ' . get_string('enrolisdisabled', 'enrol_poodllprovider');
        $this->assertContains($message, $output);
    }
    ...
    public function test_get_name() {
        $this->assertEquals(get_string('tasksyncmembers', 'enrol_poodllprovider'), $this->task->get_name());
    }
    ...
    /**
     * Enable enrol_poodllprovider plugin.
     */
    protected function enable_enrol() {
        $enabled = enrol_get_plugins(true);
        $enabled['poodllprovider'] = true;
