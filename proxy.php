...
$url = new moodle_url('/enrol/poodllprovider/tp.php');
$PAGE->set_url($url);
$PAGE->set_pagelayout('popup');
$PAGE->set_title(get_string('registration', 'enrol_poodllprovider'));
...
if (!\enrol_poodllprovider\helper::verify_proxy_token($toolid, $token)) {
