 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class enrol_poodllprovider_data_connector_testcase extends advanced_testcase {
    ...
    public function test_get_consumers_mapped_to_tool() {
        ...
        $tp = new \enrol_poodllprovider\tool_provider($tool->id);
        ...
        $tp2 = new \enrol_poodllprovider\tool_provider($tool2->id);
