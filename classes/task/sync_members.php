...
/**
 * Handles synchronising members using the enrolment poodllprovider.
 *
...
/**
 * Task for synchronising members using the enrolment poodllprovider.
 *
 * @package    enrol_poodllprovider
 * @copyright  2020 Justin Hunt <justin@poodll.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class sync_members extends scheduled_task {
    ...
    public function get_name() {
        return get_string('tasksyncmembers', 'enrol_poodllprovider');
    }
    ...
    protected function sync_unenrol(stdClass $tool) {
        ...
        foreach ($ltiusersrs as $ltiuser) {
            if (!in_array($ltiuser->userid, $this->currentusers)) {
                ...
                $poodllproviderplugin->unenrol_user($instance, $ltiuser->userid);
