...
if (!\enrol_poodllprovider\helper::verify_cartridge_token($toolid, $token)) {
...
if (!is_enabled_auth('lti')) {
...
} else if (!enrol_is_enabled('poodllprovider')) {
    ...
    echo \enrol_poodllprovider\helper::create_cartridge($toolid);
}
