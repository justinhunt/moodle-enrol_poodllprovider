...
use enrol_poodllprovider\helper;
use enrol_poodllprovider\tool_provider;
...
class tool_provider_testcase extends advanced_testcase {
    ...
    public function test_on_error() {
        ...
        $tp->message = $message;
        $tp->onError();
        $errormessage = get_string('failedrequest', 'enrol_poodllprovider', ['reason' => $message]);
    ...
    public function test_on_register_no_consumer() {
        ...
        $this->assertFalse($tp->ok);
        $this->assertEquals(get_string('invalidtoolconsumer', 'enrol_poodllprovider'), $tp->message);
    }
    ...
    public function test_on_register_no_return_url() {
        ...
        $tp->onRegister();
        $this->assertFalse($tp->ok);
        $this->assertEquals(get_string('returnurlnotset', 'enrol_poodllprovider'), $tp->message);
    }
    ...
    public function test_on_register_failed() {
        ...
        $this->assertFalse($tp->ok);
        // Check message.
        $this->assertEquals(get_string('couldnotestablishproxy', 'enrol_poodllprovider'), $tp->message);
    }
    ...
    public function test_on_register() {
        ...
        $successmessage = get_string('successfulregistration', 'enrol_poodllprovider');
    ...
    public function test_on_launch_no_frame_embedding() {
        ...
        $this->assertContains(get_string('frameembeddingnotenabled', 'enrol_poodllprovider'), $output);
    }
    ...
    public function test_on_launch_with_invalid_secret_and_no_proxy() {
        ...
        @$tp->onLaunch();
        $this->assertFalse($tp->ok);
        $this->assertEquals(get_string('invalidrequest', 'enrol_poodllprovider'), $tp->message);
    }
                    ...
                    [
                        'message' => [
                            [
                                ...
                                'path' => '/enrol/poodllprovider/tool.php'
                            ]
                        ]
                    ]
                ]
                ...
                'resource_handler' => [
                    [
                        'message' => [
                            [
                                'message_type' => 'basic-lti-launch-request',
                                'path' => '/enrol/poodllprovider/tool.php?id=' . $tool->id
                            ]
                        ]
                    ]
                ]
