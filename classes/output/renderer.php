...
/**
 * Renderer class for poodllprovider enrolment
 *
...
namespace enrol_poodllprovider\output;
...
class renderer extends plugin_renderer_base {
    /**
     * Render the enrol_poodllprovider/proxy_registration template
     *
    ...
    public function render_registration(registration $registration) {
        ...
        return parent::render_from_template("enrol_poodllprovider/proxy_registration", $data);
    }
}
