...
require_once($CFG->dirroot . '/enrol/poodllprovider/ims-blti/TrivialOAuthDataStore.php');

// Returns true if this is a Basic poodllprovider message
// with minimum values to meet the protocol
function is_basic_poodllprovider_request() {
