...
/**
 * poodllprovider enrolment plugin version information
 *
...
$string['enrolisdisabled'] = 'The \'Poodll Provider tool\' plugin is disabled.';
...
$string['poodllprovider:config'] = 'Configure \'Poodll Provider tool\' instances';
$string['poodllprovider:unenrol'] = 'Unenrol users from the course';
$string['opentool'] = 'Open tool';
$string['pluginname'] = 'Poodll Provider tool';
$string['pluginname_desc'] = 'The \'Poodll Provider tool\' plugin, together with the LTI authentication plugin, allows remote users to access selected courses and activities. In other words, Moodle functions as an LTI tool provider.';
$string['privacy:metadata:enrol_pp_users'] = 'The list of users enrolled via an poodllprovider provider';
$string['privacy:metadata:enrol_pp_users:userid'] = 'The ID of the user';
$string['privacy:metadata:enrol_pp_users:lastgrade'] = 'The last grade the user was recorded of having';
$string['privacy:metadata:enrol_pp_users:lastaccess'] = 'The time when the user last accessed the course';
$string['privacy:metadata:enrol_pp_users:timecreated'] = 'The time when the user was enrolled';
...
$string['sharedexternaltools'] = 'Published as poodllprovider tools';
$string['successfulregistration'] = 'Successful registration';
$string['tasksyncgrades'] = 'Poodll Provider tool grade sync';
$string['tasksyncmembers'] = 'Poodll Provider tool users sync';
...
$string['mediaassignment'] = 'Poodll Media Assignment';
$string['newactivity'] = "New Activity";
$string['menu'] = "Menu";
$string['whattoadd'] = "What do you want to add?";
$string['addbyactivity']="Add individual activity";
$string['addfullcourse']="Add full course";