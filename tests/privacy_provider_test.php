...
use enrol_poodllprovider\privacy\provider;
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class enrol_poodllprovider_privacy_provider_testcase extends \core_privacy\tests\provider_testcase {
    ...
    public function test_export_for_context() {
        ...
        $this->export_context_data_for_user($this->user->id, $coursecontext, 'enrol_poodllprovider');
        ...
        $this->export_context_data_for_user($this->user->id, $cmcontext, 'enrol_poodllprovider');
